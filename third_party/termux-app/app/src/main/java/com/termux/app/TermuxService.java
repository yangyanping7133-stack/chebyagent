...
public final class TermuxService extends Service implements TermuxTask.TermuxTaskClient, TermuxSession.TermuxSessionClient {
    ...
    private Notification buildNotification() {
        ...
        if (notificationIntent == null) notificationIntent = TermuxActivity.newInstance(this);
        ...
        String notificationText = res.getString(R.string.cheby_runtime_notification_text);
        ...
        Notification.Builder builder =  NotificationUtils.geNotificationBuilder(this,
            ...
            res.getString(R.string.application_name), notificationText, null,
